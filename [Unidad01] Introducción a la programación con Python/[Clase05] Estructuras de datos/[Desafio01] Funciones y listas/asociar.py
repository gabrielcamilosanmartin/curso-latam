...
asociacion = list(zip(velocidad, distancia))
velocidad_promedio = promedio(velocidad)
distancia_promedio = promedio(distancia)

result0 = list(filter(lambda x: x[0] < velocidad_promedio, asociacion))
result1 = list(filter(lambda x: (x[0] < velocidad_promedio) and (x[1] > distancia_promedio), asociacion))
result2 = list(filter(lambda x: x[0] > velocidad_promedio, asociacion))
result3 = list(filter(lambda x: (x[0] > velocidad_promedio) and (x[1] < distancia_promedio), asociacion))
print (len(result0))
print (len(result1))
print (len(result2))
print (len(result3))